    ...
    def actparser(self, group):
        ...
        while group:
            ...
            if t == ':parameters':
                ...
                self.presplit(group.pop(0), positive_preconditions, negative_preconditions, name, ' preconditions')
            elif t == ':effect':
                self.presplit(group.pop(0), add_effects, del_effects, name, ' effects')
        ...
        if type(tokens) is list and tokens.pop(0) == 'define':
            ...
            while tokens:
                ...
                if   t == 'problem':
                    ...
                    self.presplit(group[1], self.positive_goals, self.negative_goals, '', 'goals')
...
#     parser = PDDL_Parser()
#     print('----------------------------')
#     pprint.pprint(parser.check(domain))
#     print('----------------------------')
#     pprint.pprint(parser.check(problem))
#     print('----------------------------')
